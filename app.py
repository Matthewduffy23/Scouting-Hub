...
/* tile wrapper gives positioning context to the overlay button */
...
.tile-wrap .stButton>button{
  position:absolute; inset:0; border:none; background:transparent; cursor:pointer;
  color:transparent; box-shadow:none; padding:0; margin:0;
}
.tile-wrap .stButton>button:hover{ background:transparent; }
</style>
...
# Attackers (clickable -> pages/02_Attacker.py)
st.markdown('<div class="tile-wrap">', unsafe_allow_html=True)
...
# Strikers (clickable -> pages/01_Striker.py)
st.markdown('<div class="tile-wrap">', unsafe_allow_html=True)
