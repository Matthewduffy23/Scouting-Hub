...
with cC:
    min_minutes, max_minutes = st.slider("Minutes (pool)", 0, 6000, (5000, 6000))
...
def compute_strikers():
    ...
    # NOTE: Removed hard-coded Age/MV/Minutes filters here so it follows the top-bar pool filters only.
