...
treamlit.errors.StreamlitDuplicateElementId: This app has encountered an error. The original error message is redacted to prevent data leaks. Full error details have been recorded in the logs (if you're on Streamlit Cloud, click on 'Manage app' in the lower right of your app).

Traceback:
File "/mount/src/scouting-hub/pages/06_Club_Tool.py", line 2277, in <module>
...
File "/home/adminuser/venv/lib/python3.13/site-packages/streamlit/elements/widgets/selectbox.py", line 471, in selectbox
    ...
    ^
File "/home/adminuser/venv/lib/python3.13/site-packages/streamlit/elements/widgets/selectbox.py", line 543, in _selectbox
