...
# ----------------- PRO LAYOUT TAB (tiles) — GOALKEEPERS (FIXED: actually renders in tabs[4]) -----------------
import textwrap
...
# Use your full COUNTRY_TO_CC if you already have it elsewhere
COUNTRY_TO_CC = {
    ...
    "morocco":"ma","algeria":"dz","tunisia":"tn","egypt":"eg","nigeria":"ng","ghana":"gh","senegal":"sn","south africa":"za",
}
...
def render_pro_layout_gk(df_view: pd.DataFrame, top_n: int = 20):
    ...
    .pill{ padding:2px 6px; min-width:36px; border-radius:6px; font-weight:800; font-size:18px; line-height:1; color:#0b0d12; }
